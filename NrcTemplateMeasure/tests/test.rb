...
class NrcModelMeasure_Test < Minitest::Test
  ...
  def test_sample_A()
    ...
    weather_file_path = OpenstudioStandards::Weather.get_standards_weather_file_path('CAN_ON_Ottawa-CWEC2020.epw')
  ...
  def test_sample_B()
    ...
    model = standard.model_create_prototype_model(template: "NECB2017",
                                                  ...
                                                  epw_file: "CAN_AB_Edmonton-CWEC2020.epw",
  ...
  def test_sample_C()
    ...
    weather_file_path = OpenstudioStandards::Weather.get_standards_weather_file_path('CAN_BC_Vancouver-CWEC2020.epw')
    OpenstudioStandards::Weather.model_set_building_location(model, weather_file_path: weather_file_path)
